...
d3.csv("viz-data/sectorViz/IG/data-IG-pie1.csv", type, function(error, data) {
...
d3.csv("viz-data/sectorViz/IG/data-IG-pie2.csv", type, function(error, data) {
  if (error) throw error;
...
d3.csv("viz-data/sectorViz/IG/data-IG-pie3.csv", type, function(error, data) {
  if (error) throw error;
