...
d3.csv("viz-data/sectorViz/ACT/data-ACT-pie1.csv", type, function(error, data) {
...
d3.csv("viz-data/sectorViz/ACT/data-ACT-pie2.csv", type, function(error, data) {
  if (error) throw error;
...
d3.csv("viz-data/sectorViz/ACT/data-ACT-pie3.csv", type, function(error, data) {
  if (error) throw error;
