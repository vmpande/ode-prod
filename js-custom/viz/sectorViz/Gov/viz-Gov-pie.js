...
d3.csv("viz-data/sectorViz/Gov/data-Gov-pie1.csv", type, function(error, data) {
...
d3.csv("viz-data/sectorViz/Gov/data-Gov-pie2.csv", type, function(error, data) {
  if (error) throw error;
...
d3.csv("viz-data/sectorViz/Gov/data-Gov-pie3.csv", type, function(error, data) {
  if (error) throw error;
