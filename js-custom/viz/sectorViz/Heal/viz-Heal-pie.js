...
d3.csv("viz-data/sectorViz/Heal/data-Heal-pie1.csv", type, function(error, data) {
...
d3.csv("viz-data/sectorViz/Heal/data-Heal-pie2.csv", type, function(error, data) {
  if (error) throw error;
...
d3.csv("viz-data/sectorViz/Heal/data-Heal-pie3.csv", type, function(error, data) {
  if (error) throw error;
