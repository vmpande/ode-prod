...
d3.csv("viz-data/sectorViz/HRE/data-HRE-pie1.csv", type, function(error, data) {
...
d3.csv("viz-data/sectorViz/HRE/data-HRE-pie2.csv", type, function(error, data) {
  if (error) throw error;
...
d3.csv("viz-data/sectorViz/HRE/data-HRE-pie3.csv", type, function(error, data) {
  if (error) throw error;
