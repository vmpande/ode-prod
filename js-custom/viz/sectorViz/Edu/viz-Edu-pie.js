...
d3.csv("viz-data/sectorViz/Edu/data-Edu-pie1.csv", type, function(error, data) {
...
d3.csv("viz-data/sectorViz/Edu/data-Edu-pie2.csv", type, function(error, data) {
  if (error) throw error;
...
d3.csv("viz-data/sectorViz/Edu/data-Edu-pie3.csv", type, function(error, data) {
  if (error) throw error;
