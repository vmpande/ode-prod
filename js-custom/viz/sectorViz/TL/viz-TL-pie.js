...
d3.csv("viz-data/sectorViz/TL/data-TL-pie1.csv", type, function(error, data) {
...
d3.csv("viz-data/sectorViz/TL/data-TL-pie2.csv", type, function(error, data) {
  if (error) throw error;
...
d3.csv("viz-data/sectorViz/TL/data-TL-pie3.csv", type, function(error, data) {
  if (error) throw error;
