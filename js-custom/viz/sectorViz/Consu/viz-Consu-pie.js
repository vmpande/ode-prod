...
d3.csv("viz-data/sectorViz/Consu/data-Consu-pie1.csv", type, function(error, data) {
...
d3.csv("viz-data/sectorViz/Consu/data-Consu-pie2.csv", type, function(error, data) {
  if (error) throw error;
...
d3.csv("viz-data/sectorViz/Consu/data-Consu-pie3.csv", type, function(error, data) {
  if (error) throw error;
