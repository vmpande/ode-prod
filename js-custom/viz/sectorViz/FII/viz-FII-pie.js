...
d3.csv("viz-data/sectorViz/FII/data-FII-pie1.csv", type, function(error, data) {
...
d3.csv("viz-data/sectorViz/FII/data-FII-pie2.csv", type, function(error, data) {
  if (error) throw error;
...
d3.csv("viz-data/sectorViz/FII/data-FII-pie3.csv", type, function(error, data) {
  if (error) throw error;
