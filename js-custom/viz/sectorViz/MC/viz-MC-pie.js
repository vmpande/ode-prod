...
d3.csv("viz-data/sectorViz/MC/data-MC-pie1.csv", type, function(error, data) {
...
d3.csv("viz-data/sectorViz/MC/data-MC-pie2.csv", type, function(error, data) {
  if (error) throw error;
...
d3.csv("viz-data/sectorViz/MC/data-MC-pie3.csv", type, function(error, data) {
  if (error) throw error;
