...
d3.csv("viz-data/sectorViz/EC/data-EC-pie1.csv", type, function(error, data) {
...
d3.csv("viz-data/sectorViz/EC/data-EC-pie2.csv", type, function(error, data) {
  if (error) throw error;
...
d3.csv("viz-data/sectorViz/EC/data-EC-pie3.csv", type, function(error, data) {
  if (error) throw error;
